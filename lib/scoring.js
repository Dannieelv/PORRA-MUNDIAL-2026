...
// Deadline para apostas de eliminatorias = 24h antes del partido
export function getKnockoutDeadline(match) {
  if (match.datetime) {
    return new Date(new Date(match.datetime).getTime() - 24 * 3600 * 1000);
  }
  // Fallback: medianoche del día anterior
